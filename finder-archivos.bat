...
cls
  ...
  echo.
  set /p ruta-destino=Unidad de disco o Ruta de *destino* (C, D, etc.) Enter para ruta de busqueda
  ...
  echo.
  set /p destino=Introduce el nombre de la carpeta de destino, Enter para definirla como "archivos-de-[extencion]":
  echo.
  :denuevo
  cls
